...
<script setup>
  ...
  const banks = [
    {
      name: "Vietcombank",
      logo: "https://upload.wikimedia.org/wikipedia/commons/6/6f/Logo_Vietcombank.svg",
    },
    {
      name: "Techcombank",
      logo: "https://upload.wikimedia.org/wikipedia/commons/8/8c/Techcombank_logo.svg",
    },
    {
      name: "ACB",
      logo: "https://upload.wikimedia.org/wikipedia/commons/8/8d/Asia_Commercial_Bank_logo.svg",
    },
    {
      name: "MB Bank",
      logo: "https://upload.wikimedia.org/wikipedia/commons/b/bf/MB_Bank_logo.svg",
    },
    {
      name: "VPBank",
      logo: "https://upload.wikimedia.org/wikipedia/commons/5/5a/VPBank_logo.svg",
    },
    {
      name: "Agribank",
      logo: "https://upload.wikimedia.org/wikipedia/commons/1/1c/Agribank_logo_2021.svg",
    },
  ];
  ...
  const savePayment = () => {
    ...
    formError.value = "";
    toast.add({
      title: "✅ Đã lưu phương thức thanh toán!",
      color: "success",
    });
