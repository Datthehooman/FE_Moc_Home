<template>
  <div class="flex justify-center bg-[#FFFBF8] min-h-screen">
    <div class="flex w-full max-w-[85%]">
      ...
      <!-- Sidebar -->
      <!-- Đảm bảo ModulesUserAccountSidebar được định nghĩa/import đúng cách -->
        ...
        <section class="bg-white rounded-xl p-6 shadow">
          ...
          <template v-else-if="order">
              ...
              <div class="flex gap-3 items-center">
                ...
                <div v-if="order.status === 'pending'" class="relative">
                  <button 
                    ...
                    :disabled="canceling"
                  >
                    {{ canceling ? 'Đang hủy...' : (filterStatus || 'Hủy đơn hàng') }}
            ...
            <div class="mt-8 border border-gray-200 rounded-xl overflow-hidden">
              ...
              <!-- THÊM HEADER CHO CÁC CỘT SẢN PHẨM -->
              ...
              <div class="divide-y divide-gray-200">
                ...
                >
                  ...
                  <div class="w-28 text-center">
                    {{ console.log('Kiểm tra isReviewed cho ID:', product.orderDetailId, '->', product.isReviewed) }}
            ...
            <!-- Summary and Shipping Info (Giữ nguyên cấu trúc) -->
