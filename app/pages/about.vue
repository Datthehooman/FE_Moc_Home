<template>
    <UContainer class="lg:px-0">
        <div class="grid grid-cols-2 gap-[49px] relative mb-16.5 pt-[100px] pb-[100px]">
            <div class="relative h-[538px] min-w-[630px]">
                ...
                >
                    ...
                    >
                        <UIcon name="i-heroicons-bolt-20-solid" class="size-12.5 text-white" />
                        </div>
                    <p class="font-semibold w-[97px]">2000 năm<br />Kinh nghiệm</p>
                </div>
            ...
            <div class="flex flex-col">
                ...
                <div class="grid grid-cols-2 gap-4 mb-8 text-black">
                    <div class="flex items-center gap-2">
                        ...
                        >
                            <UIcon name="i-heroicons-check-circle-20-solid" class="text-white" />
                        </div>
                ...
                >
                    ...
                    >
                        ...
                        <UIcon name="i-heroicons-arrow-right-20-solid"></UIcon>
                    </span>
                </UButton>
            </div>
        </div>
    ...
    <div class="font-sans min-h-screen relative flex flex-col items-center p-4 sm:p-0 bg-white">

    <section class="w-full relative z-10 overflow-hidden flex flex-col items-center bg-[#F5E7D5] pt-16 pb-20">
        
        <div class="absolute inset-0 z-0 pointer-events-none">
            <div class="absolute -top-1/4 -left-1/4 w-[600px] h-[600px] sm:w-[900px] sm:h-[900px] rounded-full bg-gradient-to-br from-white/60 to-yellow-200/50 transform rotate-45"></div>
            <div class="absolute -bottom-1/4 -right-1/4 w-[600px] h-[600px] sm:w-[900px] sm:h-[900px] rounded-full bg-gradient-to-tl from-[#E8C59A]/60 to-[#F5E7D5]/60 transform -rotate-45"></div>
        </div>

        <div class="relative z-10 w-full max-w-7xl px-4">
            
            <div class="text-center mb-12">
                <p class="text-xl text-amber-900/70 uppercase tracking-widest mb-2 font-medium">Lời Chứng Thực</p>
                <h2 class="text-4xl sm:text-5xl text-amber-900">Những gì khách hàng của chúng tôi nói</h2>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white p-6 rounded-xl shadow-xl relative transform transition duration-300 hover:shadow-2xl">
                    ...
                    <p class="text-gray-700 text-sm leading-relaxed mb-5">
                        Nội thất ở đây đẹp vừa chắc chắn, thiết kế tinh tế đúng như mô tả. Giá cả hợp lý, giao hàng nhanh và đóng gói cẩn thận, rất đáng để tin tưởng và lựa chọn lâu dài.
                    </p>
                    <div class="text-yellow-500 text-lg">
                        <UIcon name="i-heroicons-star-20-solid" /><UIcon name="i-heroicons-star-20-solid" /><UIcon name="i-heroicons-star-20-solid" /><UIcon name="i-heroicons-star-20-solid" /><UIcon name="i-heroicons-star-20-solid" />
                    </div>
                </div>
            ...
            <div class="flex justify-center mt-10 space-x-3">
                <span class="w-2.5 h-2.5 rounded-full bg-amber-900"></span>
                <span class="w-2.5 h-2.5 rounded-full bg-amber-900/50"></span>
                <span class="w-2.5 h-2.5 rounded-full bg-amber-900/50"></span>
            </div>
        </div>
    </section>

    <section class="w-full relative z-10 flex flex-col items-center bg-[#FDF8F0] pt-16 pb-20">
        <div class="relative z-10 w-full max-w-7xl px-4">
        
            <div class="text-center mb-16">
                <p class="text-xl text-amber-900/70 uppercase tracking-widest mb-2 font-medium">Đội Ngũ Của Chúng Tôi</p>
                <h2 class="text-4xl sm:text-5xl text-amber-900">Gặp gỡ đội ngũ chuyên gia của chúng tôi</h2>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="bg-white p-4 pt-0 rounded-xl shadow-lg border-t-8 border-transparent transition duration-300 hover:shadow-xl hover:border-amber-900/50">
                    ...
                    <div class="text-center">
                        <p class="font-bold text-xl text-amber-900 mt-2">Bùi Nguyên Đạt</p>
                        <p class="text-md text-gray-600 mb-4">Quản lý cấp cao</p>
                        
                        <div class="flex justify-center space-x-3 pb-2">
                            <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-[#EADCCB] text-amber-900 hover:bg-amber-900 hover:text-white transition-colors">
                                <UIcon name="i-lucide-facebook" class="text-lg" />
                            </a>
                            <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-[#EADCCB] text-amber-900 hover:bg-amber-900 hover:text-white transition-colors">
                            ...
                            <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-[#EADCCB] text-amber-900 hover:bg-amber-900 hover:text-white transition-colors">
                                <UIcon name="i-lucide-youtube" class="text-lg" />
                            </a>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white p-4 pt-0 rounded-xl shadow-lg border-t-8 border-transparent transition duration-300 hover:shadow-xl hover:border-amber-900/50">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-md text-gray-600 mb-4">Quản lý cấp cao</p>
                        <div class="flex justify-center space-x-3 pb-2">
                            <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-[#EADCCB] text-amber-900 hover:bg-amber-900 hover:text-white transition-colors"><UIcon name="i-lucide-facebook" class="text-lg" /></a>
                            <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-[#EADCCB] text-amber-900 hover:bg-amber-900 hover:text-white transition-colors"><UIcon name="i-lucide-instagram" class="text-lg" /></a>
                            <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-[#EADCCB] text-amber-900 hover:bg-amber-900 hover:text-white transition-colors"><UIcon name="i-lucide-github" class="text-lg" /></a>
                            <a href="#" class="w-8 h-8 flex items-center justify-center rounded-full bg-[#EADCCB] text-amber-900 hover:bg-amber-900 hover:text-white transition-colors"><UIcon name="i-lucide-youtube" class="text-lg" /></a>
                        </div>
                    </div>
                </div>
    ...
    <div class="font-sans min-h-screen relative flex flex-col items-center bg-[#FDF8F0]">

    <section class="w-full relative z-10 flex flex-col items-center pt-16 pb-20 bg-[#FDF8F0]">
        
        <div class="w-full max-w-7xl rounded-xl shadow-lg p-8 mb-16 mx-4" style="background-color: #F8EFE4;">
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 text-center">
                
                <div class="flex flex-col items-center">
                    <div class="w-14 h-14 flex items-center justify-center rounded-full bg-[#E4C7A7] text-amber-900 mb-2">
                        <UIcon name="i-lucide-truck" class="text-2xl" />
                    </div>
                    <p class="font-bold text-lg text-amber-900">Giao hàng miễn phí</p>
                    <p class="text-sm text-gray-600">Đơn hàng trên 5 triệu</p>
                </div>

                <div class="flex flex-col items-center">
                    <div class="w-14 h-14 flex items-center justify-center rounded-full bg-[#E4C7A7] text-amber-900 mb-2">
                        <UIcon name="i-lucide-undo-2" class="text-2xl" />
                    </div>
                    <p class="font-bold text-lg text-amber-900">Nhận hoàn tiền</p>
                    <p class="text-sm text-gray-600">Trả hàng trong vòng 30 ngày</p>
                </div>
                ...
                <div class="flex flex-col items-center">
                    ...
                    <p class="font-bold text-lg text-amber-900">Uy tín</p>
                    <p class="text-sm text-gray-600">Thanh toán an toàn 100%</p>
                </div>

                <div class="flex flex-col items-center">
                    <div class="w-14 h-14 flex items-center justify-center rounded-full bg-[#E4C7A7] text-amber-900 mb-2">
                        <UIcon name="i-lucide-headphones" class="text-2xl" />
                    </div>
                    <p class="font-bold text-lg text-amber-900">Hỗ trợ 24/7</p>
                    <p class="text-sm text-gray-600">Hãy gọi cho chúng tôi</p>
                </div>
            </div>
        </div>
