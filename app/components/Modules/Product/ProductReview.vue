      ...
      >
        <div :key="tab" class="mt-6 text-gray-700 leading-relaxed">
          <div v-if="tab === 'mota'">
            ...
            >
              <div class="mb-6">
                <h3 class="font-bold text-[18px] text-[#6E4E37] mb-3">
                  Mô tả sản phẩm
                </h3>
                <p class="text-gray-700 leading-relaxed text-[17px]">
                  <span v-if="loadingDetail">Đang tải mô tả...</span>
                  <span v-else>{{
                    productDetail?.description || "Không có mô tả chi tiết."
                  }}</span>
                </p>
              </div>
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-4">
                  <h3 class="font-bold text-lg text-[#6E4E37] mb-3">
                    Thông tin sản phẩm
                  </h3>
                  <ul class="text-[15px] space-y-3">
                    <li class="flex items-start">
                      <span class="font-semibold text-gray-800 min-w-[120px]"
                        >Tình trạng:</span
                      >
                      <span
                        v-if="loadingDetail"
                    ...
                    <li class="flex items-start">
                      ...
                      <span
                        v-else
                        class="font-medium text-gray-700 bg-gray-50 px-2 py-1 rounded"
                      >
          ...
          <div v-else>
              ...
              >
                ...
                <div class="flex-1 relative">
                  ...
                  <h3 class="font-semibold text-gray-800 text-[17px]">
                    {{
                      review.name ||
                      review.order_detail?.order?.customer_name ||
                      "Người dùng ẩn danh"
                    }}
                  </h3>
                  <p class="text-sm text-gray-500 mt-1 flex items-center gap-1">
                    ...
                    <span
                      v-if="review.order_detail?.order?.order_code"
                      class="text-xs ml-2 px-2 py-0.5 bg-gray-100 rounded"
                    >
            ...
            >
              ...
              <div class="flex items-center mb-4 space-x-1">
                <span class="text-[15px] font-medium text-gray-700 mr-3"
                  >Đánh giá:</span
                >
                <svg
                  v-for="n in 5"
...
<script setup lang="ts">
  ...
  const { productDetail, loadingDetail, errorDetail, fetchProductDetail } =
    useProduct();
  ...
  const submitReview = () => {
    ...
    toast.add({
      title: "Đánh giá của bạn đã được thêm",
      color: "success",
    });
