import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { useSlots, ref, inject, computed, mergeProps, unref, withCtx, renderSlot, createBlock, createCommentVNode, openBlock, toDisplayString, createVNode, defineComponent, resolveDynamicComponent, toValue, watch, provide, shallowRef, h, resolveComponent, hasInjectionContext, toRef, useAttrs, mergeModels, useModel, createTextVNode, reactive, isRef, getCurrentInstance, onServerPrefetch, nextTick, createElementBlock, cloneVNode, defineAsyncComponent, useSSRContext, shallowReactive, Suspense, Fragment, createApp, renderList, useId, onErrorCaptured, effectScope, isReadonly, isShallow, isReactive, toRaw, withModifiers, getCurrentScope, markRaw } from 'vue';
import { s as serialize, l as defu, m as klona, n as defuFn, o as parseQuery, f as destr, i as hasProtocol, q as isScriptProtocol, j as joinURL, t as hash, v as parse, w as getRequestHeader, x as isEqual, y as withQuery, z as sanitizeStatusCode, A as withTrailingSlash, B as withoutTrailingSlash, C as setCookie, D as getCookie, E as deleteCookie, F as getContext, e as createError$1, G as withLeadingSlash, H as parseURL, $ as $fetch$1, I as baseURL, p as publicAssetsURL, J as createHooks, K as executeAsync, L as encodeParam, M as encodePath, N as toRouteMatcher, O as createRouter$1 } from '../nitro/nitro.mjs';
...
import { ssrRenderComponent, ssrRenderSlot, ssrRenderClass, ssrInterpolate, ssrRenderVNode, ssrRenderAttrs, ssrRenderList, ssrRenderSuspense, ssrRenderStyle, ssrRenderAttr } from 'vue/server-renderer';
...
const _routes = [
  {
    name: "cart",
    path: "/cart",
    component: () => import('./cart-DZdLDFZe.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-BrsktXQt.mjs')
  },
  {
    name: "login",
    path: "/login",
    component: () => import('./login-C9RDiNxX.mjs')
  },
  {
    name: "contact",
    path: "/contact",
    component: () => import('./contact-s13VAVpM.mjs')
  },
  {
    name: "checkout",
    path: "/checkout",
    component: () => import('./checkout-U3bQXAa2.mjs')
  },
  {
    name: "register",
    path: "/register",
    component: () => import('./register-BxgUGc22.mjs')
  },
  {
    name: "OtpVerify",
    path: "/OtpVerify",
    component: () => import('./OtpVerify-BLE4bT7x.mjs')
  },
  {
    name: "TestLogin",
    path: "/TestLogin",
    component: () => import('./TestLogin-Bgyo8Fgv.mjs')
  },
  {
    name: "TestToken",
    path: "/TestToken",
    component: () => import('./TestToken-DN5Yda9-.mjs')
  },
  {
    name: "blog",
    path: "/blog",
    component: () => import('./index-CfrQBetK.mjs')
  },
  {
    name: "san-pham-2",
    path: "/san-pham/2",
    component: () => import('./2-Dg5JEQIB.mjs')
  },
  {
    name: "blog-slug",
    path: "/blog/:slug()",
    component: () => import('./_slug_-C9YTy0BM.mjs')
  },
  {
    name: "ProductList",
    path: "/ProductList",
    component: () => import('./ProductList-B5-vT4am.mjs')
  },
  {
    name: "san-pham-31",
    path: "/san-pham/31",
    component: () => import('./31-D8wvZYOb.mjs')
  },
  {
    name: "user-orders",
    path: "/user/orders",
    component: () => import('./orders-BkrQ5jkd.mjs')
  },
  {
    name: "user-address",
    path: "/user/address",
    component: () => import('./address-B669k0z-.mjs')
  },
  {
    name: "user-payment",
    path: "/user/payment",
    component: () => import('./payment-CiJGm4U1.mjs')
  },
  {
    name: "user-profile",
    path: "/user/profile",
    component: () => import('./profile-CGqZ4f8j.mjs')
  },
  {
    name: "user-support",
    path: "/user/support",
    component: () => import('./support-DWyDaKxR.mjs')
  },
  {
    name: "test-products",
    path: "/test-products",
    component: () => import('./test-products-DpPgwdOg.mjs')
  },
  {
    name: "TestThumbnail",
    path: "/TestThumbnail",
    component: () => import('./TestThumbnail-CuWKDYBN.mjs')
  },
  {
    name: "user-messages",
    path: "/user/messages",
    component: () => import('./messages-CJSvXy3N.mjs')
  },
  {
    name: "user-settings",
    path: "/user/settings",
    component: () => import('./settings-DTH2yWo6.mjs')
  },
  {
    name: "user-wishlist",
    path: "/user/wishlist",
    meta: { "middleware": "auth" },
    component: () => import('./wishlist-CXE_z3lk.mjs')
  },
  {
    name: "reset-password",
    path: "/reset-password",
    component: () => import('./reset-password-CbEyQFU9.mjs')
  },
  {
    name: "user-dashboard",
    path: "/user/dashboard",
    component: () => import('./dashboard-DMrwiVsR.mjs')
  },
  {
    name: "san-pham-slug",
    path: "/san-pham/:slug()",
    component: () => import('./_slug_-BcM9M7Q7.mjs')
  },
  {
    name: "user-add_address",
    path: "/user/add_address",
    component: () => import('./add_address-BL7zsm1g.mjs')
  },
  {
    name: "user-add_payment",
    path: "/user/add_payment",
    component: () => import('./add_payment-7p0JdeU_.mjs')
  },
  {
    name: "user-orderdetail",
    path: "/user/orderdetail",
    component: () => import('./orderdetail-jjSdQu5K.mjs')
  },
  {
    name: "user-track-order",
    path: "/user/track-order",
    component: () => import('./track-order-DsLl59QK.mjs')
  },
  {
    name: "user-notifications",
    path: "/user/notifications",
    component: () => import('./notifications-pW9cMv7V.mjs')
  }
];
...
const customFetch_fWiIapezY6degOkBGxkn0jE77VfJvBkogk6lFmIy8fs = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  ...
  const $customFetch = $fetch.create({
    ...
    async onResponseError({ request, response }) {
      ...
      const skipLogout = url.includes("/login") || url.includes("/register") || url.includes("/forgot") || url.includes("/reset");
...
const plugins = [
  ...
  customFetch_fWiIapezY6degOkBGxkn0jE77VfJvBkogk6lFmIy8fs
];
...
const ipxRuntime$c5bYuDBMFn7pLf3NiYFFTgAhjpBXVLzp5UXALzaMXO0 = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  getImage,
  operationsGenerator,
  supportsAlias,
...
const imageOptions = {
  ...
  providers: {
    ["ipx"]: { provider: ipxRuntime$c5bYuDBMFn7pLf3NiYFFTgAhjpBXVLzp5UXALzaMXO0, defaults: {} }
  }
};
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.src && !error.value) {
              ssrRenderVNode(_push2, createVNode(resolveDynamicComponent(unref(__nuxt_component_1$1)), mergeProps({
                src: __props.src,
                alt: __props.alt,
                width: sizePx.value,
                height: sizePx.value
            ...
            return [
              __props.src && !error.value ? (openBlock(), createBlock(resolveDynamicComponent(unref(__nuxt_component_1$1)), mergeProps({
                key: 0,
                src: __props.src,
                alt: __props.alt,
                width: sizePx.value,
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-CdNJKum4.mjs').then((m) => m.default || m))
};
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(ssrRenderComponent(_component_NuxtLayout, null, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(`<div class="bg-[#FFFBF8] min-h-screen"${_scopeId2}>`);
              _push3(ssrRenderComponent(_component_NuxtPage, null, null, _parent3, _scopeId2));
              _push3(`</div>`);
            } else {
              return [
                createVNode("div", { class: "bg-[#FFFBF8] min-h-screen" }, [
...
const _imports_0 = publicAssetsURL("/error.png");
const _sfc_main$1 = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtLink = __nuxt_component_0$2;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col items-center justify-center min-h-screen bg-[#FFF8F3] p-6 text-center" }, _attrs))}><img${ssrRenderAttr("src", _imports_0)} alt="404 Not Found" class="w-[405px] h-[330px] object-cover mb-6"><h1 class="text-[32px] font-bold text-gray-800 mb-3">OMG... Không tìm thấy trang!</h1><p class="text-[15px] text-gray-600 mb-6"> Trang bạn đang tìm kiếm không tìm thấy có thể là do nó không tồn tại hoặc đã bị xóa. </p>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/",
    class: "px-6 py-3 bg-[#F7C59F] text-[#6E4E37] font-semibold rounded-lg shadow hover:bg-[#E8B58C] transition"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(` Quay về trang chủ `);
      } else {
        return [
          createTextVNode(" Quay về trang chủ ")
        ];
      }
    }),
    _: 1
...
export { _sfc_main$8 as _, useAppConfig as a, _sfc_main$e as b, __nuxt_component_1$1 as c, useFieldGroup as d, entry$1 as default, useComponentIcons as e, _sfc_main$b as f, _export_sfc as g, get as h, useFormField as i, useCustomFetch as j, __nuxt_component_0$2 as k, looseToNumber as l, useCookie as m, usePortal as n, defineNuxtRouteMiddleware as o, navigateTo as p, _sfc_main$9 as q, useRoute as r, tv as t, useLocale as u };
